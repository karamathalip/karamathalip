/**
 * Stickman.tsx — SVG stick-figure character
 *
 * Phase 5A: Hero object — skeleton-based SVG stickman.
 * Poses included: standing, pointing, hero_pose, victory_pose, thumbs_up,
 * shocked, epic_win, storytelling_pose, mind_blown, celebrate
 *
 * Phase 7: Motion primitives — spring entrance, jump, shock scale, idle bob
 */
...
const SKELETONS: Record<Pose, Skeleton> = {
  standing: {
    ...
    lArmX: -32, lArmY: -14, rArmX: 32, rArmY: -14,
  ...
  pointing: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -32, lArmY: -14, rArmX: 56, rArmY: -18,
  ...
  hero_pose: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -42, lArmY: -2, rArmX: 42, rArmY: -2,
  ...
  victory_pose: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -45, lArmY: -60, rArmX: 45, rArmY: -60,
  ...
  thumbs_up: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -32, lArmY: -14, rArmX: 38, rArmY: -52,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  shocked: {
    headCx: 0, headCy: -65,
    ...
    lArmX: -50, lArmY: -20, rArmX: 50, rArmY: -20,
  ...
  epic_win: {
    ...
    lArmX: -56, lArmY: -74, rArmX: 56, rArmY: -74,
  ...
  storytelling_pose: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -16, lArmY: -2, rArmX: 52, rArmY: -26,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  mind_blown: {
    headCx: 0, headCy: -68,
    ...
    lArmX: -54, lArmY: -36, rArmX: 54, rArmY: -36,
  ...
  celebrate: {
    ...
    shoulderX: 0, shoulderY: -48,
    lArmX: -46, lArmY: -68, rArmX: 46, rArmY: -68,
  ...
  jumping: {
    ...
    lArmX: -38, lArmY: -30, rArmX: 38, rArmY: -30,
    lLegX: -28, lLegY: 24, rLegX: 28, rLegY: 24,
  },
  idle: {
    headCx: 0, headCy: -60,
    spineX1: 0, spineY1: -44, spineX2: 2, spineY2: 2,
    shoulderX: 0, shoulderY: -32,
    lArmX: -28, lArmY: -8, rArmX: 28, rArmY: -8,
    lLegX: -18, lLegY: 40, rLegX: 18, rLegY: 40,
  },
  confused: {
    headCx: 4, headCy: -64,
    spineX1: 0, spineY1: -48, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -36,
    lArmX: -30, lArmY: -10, rArmX: 36, rArmY: -28,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  scratching_head: {
    headCx: 0, headCy: -62,
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -30, lArmY: -12, rArmX: 18, rArmY: -62,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  painting: {
    headCx: 0, headCy: -62,
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -40, lArmY: -18, rArmX: 52, rArmY: -30,
    lLegX: -20, lLegY: 38, rLegX: 20, rLegY: 38,
  },
  shoving: {
    headCx: 0, headCy: -62,
    spineX1: 0, spineY1: -46, spineX2: 4, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: 44, lArmY: -22, rArmX: 48, rArmY: -16,
  ...
  cash: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -36, lArmY: -20, rArmX: 44, rArmY: -30,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  cheering: {
    headCx: 0, headCy: -72,
    spineX1: 0, spineY1: -56, spineX2: 0, spineY2: -8,
    shoulderX: 0, shoulderY: -44,
    lArmX: -50, lArmY: -66, rArmX: 50, rArmY: -66,
  ...
  pointing_up: {
    ...
    spineX1: 0, spineY1: -46, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -34,
    lArmX: -30, lArmY: -12, rArmX: 20, rArmY: -70,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  nodding: {
    headCx: 2, headCy: -58,
    spineX1: 0, spineY1: -44, spineX2: 0, spineY2: 0,
    shoulderX: 0, shoulderY: -32,
    lArmX: -28, lArmY: -10, rArmX: 28, rArmY: -10,
    lLegX: -18, lLegY: 38, rLegX: 18, rLegY: 38,
  },
  tracking: {
    headCx: 0, headCy: -62,
...
const POSE_MAP: Record<string, Pose> = {
  juggling_pose: "pointing",
  baking_gesture: "painting",
  push_gesture: "shoving",
  money_gesture: "cash",
  explosion_pose: "epic_win",
  dramatic_point_at_camera: "pointing",
  side_by_side_compare: "hero_pose",
  present_gift_pose: "thumbs_up",
  write_on_board: "storytelling_pose",
  bridge_gesture: "hero_pose",
  bridge_building_gesture: "hero_pose",
  hero_cape_pose: "hero_pose",
  world_transforms_around_hero: "epic_win",
  thinking: "scratching_head",
  scratch: "scratching_head",
  create: "painting",
  force: "shoving",
  earn: "cash",
  cheer: "cheering",
  nod: "nodding",
  point_up: "pointing_up",
  track: "tracking",
};
...
export const Stickman: React.FC<StickmanProps> = ({
  ...
  // ── Entrance spring (smooth overshoot) ──────────────────────────────────
  ...
  // ── Jump offset for celebrate / epic_win ────────────────────────────────
  ...
  // ── Shock scale for shocked / mind_blown (more dramatic) ────────────────
  ...
  // ── Idle bob (smooth sine wave) ─────────────────────────────────────────
  const idleBob = Math.sin(t * Math.PI * 1.8) * 3;

  // ── Storytelling gesture oscillation ────────────────────────────────────
  const storyGestureX = pose === "storytelling_pose"
    ? Math.sin(t * Math.PI * 1.2) * 8 : 0;

  // ── Nodding head bob ────────────────────────────────────────────────────
  const nodBob = pose === "nodding"
    ? Math.sin(t * Math.PI * 3) * 4 : 0;

  // ── Scratching head oscillation ─────────────────────────────────────────
  const scratchOsc = pose === "scratching_head"
    ? Math.sin(t * Math.PI * 6) * 3 : 0;

  // ── Glow aura (breathing intensity) ─────────────────────────────────────
  ...
  // ── Walking / talking idle arm micro-animation ──────────────────────────
  const armSwing = (pose === "standing" || pose === "thumbs_up")
    ? Math.sin(t * Math.PI * 2.5) * 2 : 0;

  // ── Tracking head offset (follows trackX target) ───────────────────────
  ...
  const maxSvgX = CANVAS_W - CLAMP_MARGIN; // 1000

  // Helper: clamp an SVG x-coordinate so the rendered pixel stays within bounds
  // SVG-x → screen-x ≈ x + svgX * pixelsPerUnit * combinedScale  (approx)
  // Solve for max svgX: screenX = maxSvgX → svgX_max ≈ (maxSvgX - x) / (4.5 * baseScale * combinedScale)
  const ppu = 4.5 * baseScale;
  const clampRight = (sx: number) => {
    const screenX = x + sx * ppu * combinedScale;
    if (screenX > maxSvgX) {
      return (maxSvgX - x) / (ppu * combinedScale);
    }
    return sx;
  };

  // Clamp right-extending skeleton endpoints
  ...
  return (
    ...
    >
      ...
      {/* Aura layer (duplicate body at low opacity with blur) */}
      ...
      {/* Face (drawn relative to head center) */}
      ...
      {/* Painting: brush sprite at right hand + cyan dot trail */}
      {pose === "painting" && (
        <>
          <rect x={clampedRArm.x - 2} y={sk.rArmY - 12} width={4} height={16}
            rx={2} fill="#8B4513" />
          <rect x={clampedRArm.x - 4} y={sk.rArmY - 16} width={8} height={6}
            rx={1} fill="#00d4ff" />
          {[0, 1, 2].map((di) => (
            <circle
              key={di}
              cx={clampedRArm.x - 8 - di * 6}
              cy={sk.rArmY - 10 + di * 4}
              r={2.5 - di * 0.5}
              fill="#00d4ff"
              opacity={0.7 - di * 0.2}
          ...
          {/* Cake sprite appearing as brush paints */}
      ...
      {/* Cash: $$ sign near right hand + yellow sparkles */}
      {pose === "cash" && (
        <>
          <text
            x={clampRight(sk.rArmX + 6)}
            y={sk.rArmY - 6}
            fontSize={14}
            fontWeight="bold"
            fill="#ffe600"
          ...
          {[0, 1, 2, 3].map((si) => {
            ...
            return (
              <circle
                key={si}
                cx={clampRight(sk.rArmX + 6 + Math.cos(angle) * sr)}
                cy={sk.rArmY - 6 + Math.sin(angle) * sr}
                r={1.5}
                fill="#ffe600"
                opacity={0.8}
              />
      ...
      {/* Pointing up: finger triangle at right hand tip */}
      {pose === "pointing_up" && (
        <polygon
      ...
      {/* Shoving: second stickman being pushed */}
      {pose === "shoving" && (
